...
// WARNING: This code, actually, does nothing w.r.t Raft algorithm. I'm trying to
// port some of the Raft consensus logic inside P4.
// All it does is to forward packets.
